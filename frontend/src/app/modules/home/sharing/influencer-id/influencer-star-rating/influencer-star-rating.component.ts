...
@Component({
  selector: 'app-influencer-star-rating',
  templateUrl: './influencer-star-rating.component.html',
  styleUrls: ['./influencer-star-rating.component.scss'],
})
export class InfluencerStarRatingComponent {
